      ...
      <div class="bg-white border border-slate-200 rounded-sm shadow-2xl p-8 relative overflow-hidden">
        ...
        <div class="space-y-5">
          ...
          <div>
            ...
            <input v-model="credentials.username" type="text" placeholder="Masukkan username..." class="w-full bg-slate-50 border border-slate-200 rounded-sm py-3 px-4 text-sm outline-none focus:border-emerald-600 font-bold" />
          </div>
          <div>
            <label class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1 block">Password</label>
            <input v-model="credentials.password" type="password" placeholder="••••••••" class="w-full bg-slate-50 border border-slate-200 rounded-sm py-3 px-4 text-sm outline-none focus:border-emerald-600 font-bold" />
          </div>
          
          <button @click="manualLogin" :disabled="loading" class="w-full bg-emerald-700 text-white py-3 rounded-sm font-black text-xs uppercase tracking-[0.2em] hover:bg-emerald-800 transition-all shadow-lg shadow-emerald-700/20 active:scale-[0.98] disabled:opacity-50">
          ...
          <button @click="loginWithGoogle" class="w-full bg-white border border-slate-200 py-3 rounded-sm flex items-center justify-center gap-3 hover:bg-slate-50 hover:border-slate-300 transition-all shadow-sm active:scale-[0.98]">
